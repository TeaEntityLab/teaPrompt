...
| C15 | Both flow packs at the 20k lint warning — 31 and 73 chars of whole-file headroom (the lens's ~700–800 figure counted the body; `lint_skills.py` counts the file; corrected 2026-09-14 second pass); the next adoption breaks the guard | PackDiffs | **Roadmap** — Horizon 1 zero-sum rule now; Horizon 2 lint-tier decision (a policy call, not a unilateral change) |
