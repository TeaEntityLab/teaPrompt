...
**Results:**
- Tested 18 adversarial groups with 62 paraphrases
- Overall consistency: 100.0% (passes Phase-1 threshold >=80% and aspirational target >=90%)
- Low-confidence route trace coverage: 100.0%
...
- Current minimums: ROUTE-001 (12 intent + 4 adversarial groups, 128 phrases); ROUTE-002 (40 holdout groups, 114 phrases); ROUTE-003 (18 adversarial groups, 62 phrases)
...
| Adversarial routing consistency | 100.0% | ✅ ROUTE-003 (18 groups, 62 paraphrases), seeded adversarial fixture |
...
2. **ROUTE-001/002/003 in CI** — 128 + 114 + 62 paraphrases at 100% consistency (seeded fixtures); `validate_route_fixture.py` gates minimum coverage
