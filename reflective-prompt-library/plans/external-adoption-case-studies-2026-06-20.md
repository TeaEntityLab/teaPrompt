...
| agentflow survey recorded; three sentences adopted post-panel by user direction; entry-point addendum recorded; EP-1/EP-6 adopted by user direction; concept addendum recorded with CX-1–CX-6 adopted; author-talk addendum recorded, skills unchanged, synthesis-grounding Durable Lesson adopted | done | `agentflow-survey-2026-09-05.md` (+ addendum) + Case Comparison row + `test_agentflow_survey_record.py` (five adopted sentences pinned at single surfaces; loophole qualifier absent; EP dispositions; no lighter-route lock) |
