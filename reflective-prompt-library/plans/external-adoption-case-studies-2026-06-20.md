...
| 2026-07-16 | fable-method v1.4.0 | GitHub repo/API + pinned clone + arXiv + upstream issue #3 | no — loop methodology present/adjacent; forced-artifact gates and trap-eval discipline are merge candidates, not new surfaces | Study strongly; adoption candidates FM1–FM3 deferred pending same-harness reproduction; parallel-skill install rejected (FM4); no TeaPrompt skill, lens, verifier, dependency, or runtime adoption | [survey](fable-method-survey-2026-07-16.md) |
