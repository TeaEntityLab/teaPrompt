...
| agentflow survey recorded; three sentences adopted post-panel by user direction; entry-point addendum recorded | done | `agentflow-survey-2026-09-05.md` (+ addendum) + Case Comparison row + `test_agentflow_survey_record.py` (adopted sentences pinned; loophole qualifier absent; EP dispositions; deferred sentences absent) |
