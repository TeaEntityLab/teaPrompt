...
| GD-19 — "deliver / autonomous / unattended" collision measurement | ≥3 fresh ROUTE-002/003 holdout groups before any quick-cue or fixture change | `ROUTING_CONTRACT.md`; ROUTE fixtures | [GD adoption GD-19](governed-delivery-adoption-2026-09-03.md) |
...
| Cross-core traceability checklist (`reflective-implement` step 4 restates the `reflective-spec-plan` Decision Gate) | A decision on core-skill cross-referencing versus the per-skill self-contained claim | `reflective-implement` Workflow; `reflective-spec-plan` Decision Gate | [September review D8](september-skills-review-2026-09-14.md) |
| Ledger status vocabulary (`asserted` / `unverified` / `pending` / `open` for one epistemic state) | A documented cross-skill handoff confusion attributable to the divergence | GLOSSARY; the four ledgers | [September review](september-skills-review-2026-09-14.md) |
| Pack example coverage (orchestrator, router, DAG, writer-critic floor, multi-wave) | A host run of one of those templates, or the flow-pack lint-tier decision | `skills/examples/flow-*.examples.md` | [September review](september-skills-review-2026-09-14.md) |
