...
多視角 Socratic 共識（單一宿主，非 agent runtime）記錄於 [plans/multi-agent-panel-consensus-2026-06-25.md](plans/multi-agent-panel-consensus-2026-06-25.md)。宣稱 routing 或 governance 變更已驗證前，需跑 `make all`。
...
- 分流口訣：[SKILL_TRIGGER_CHEATSHEET.zh-TW.md](skills/SKILL_TRIGGER_CHEATSHEET.zh-TW.md)

## 使用建議

先看 [skills/SKILL_TRIGGER_CHEATSHEET.zh-TW.md](skills/SKILL_TRIGGER_CHEATSHEET.zh-TW.md) 選 workflow；需要完整契約時再看英文 `skills/*/SKILL.md`，並用 `skills/examples/` 找最接近的操作模板。
