...
4. **Optionally write acceptance.yaml.** Locked, small (3–6 checks), covering the highest-value invariants. Mark it read-only; a spec-vs-product mismatch must be classifiable as spec-oracle error.
